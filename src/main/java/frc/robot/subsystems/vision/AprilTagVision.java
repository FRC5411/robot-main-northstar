...
import frc.libs.Alert;
import frc.libs.Alert.AlertType;
import frc.libs.GeomUtil;
import frc.libs.PoseEstimator.TimestampedVisionUpdate;
import frc.libs.VirtualSubsystem;
        ...
        cameraPoses =
            new Pose3d[] {
              ...
              new Pose3d(
                  ...
                  Units.inchesToMeters(6.752) + Constants.Swerve.wheelRadius,
